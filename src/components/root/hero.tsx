...
export default function Hero() {
  return (
    <section className="mt-16 flex flex-col items-center justify-center text-center sm:mt-34 font-inter">
      ...
      <div className="mt-8 flex w-full flex-col justify-center px-3 sm:flex-row">
      ...
      <div className="relative mx-auto ml-3 mt-20 h-fit w-[40rem] max-w-6xl sm:ml-auto sm:w-full sm:px-2">
        <section className="flow-root">
          <div className="rounded-2xl bg-slate-50/40 p-2 ring-1 ring-inset ring-slate-200/50 dark:bg-gray-900/70 dark:ring-white/10">
            <div className="rounded-xl bg-background ring-1 ring-slate-900/5 dark:ring-white/15">
              <ThemedImage
        ...
        <div className="absolute inset-x-0 -bottom-20 -mx-10 h-2/4 bg-gradient-to-t from-white via-white to-transparent lg:h-1/4 dark:from-gray-950 dark:via-gray-950" />
      </div>
    </section>
  );
}
